...
```{r}
library(graphics)
coplot(len ~ dose | supp, ToothGrowth, panel = panel.smooth, show.given = FALSE, ylab = "Tooth length", xlab = c("Dose (mg)", "Tooth Growth caused by supplements (Orange Juice - Left, Ascorbic Acid - Right)"))
```
